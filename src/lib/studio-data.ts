...
export const STUDIO_SERVICES = [
  {
    num: '(001)',
    title: 'Asymmetric Optical Diode Ingress',
    category: 'PHYSICAL LAYER',
    desc: 'Passive ingestion across severed transmit optical taps with zero packet injection capability and absolute air-gap guarantee.',
  },
  {
    num: '(002)',
    title: 'Physical Non-Return Verification',
    category: 'HARDWARE AUDIT',
    desc: 'Hardware transceiver inspection and continuous physical link validation verifying that backchannel reflection is zero.',
  },
  {
    num: '(003)',
    title: 'Multi-Resolution Feature Extraction',
    category: 'STREAMING ANALYTICS',
    desc: '24 telemetry features computed over 2.0s rolling windows across Packet, Connection, Session, and DNS abstraction layers.',
  },
  {
    num: '(004)',
    title: 'Adaptive Welford EWMA Baselines',
    category: 'STATISTICAL MODELING',
    desc: 'Online statistical tracking that learns normal diurnal host behavior and updates running variance without model retraining.',
  },
  {
    num: '(005)',
    title: 'Unsupervised Isolation Forest Outliers',
    category: 'MACHINE LEARNING',
    desc: 'Ensemble of 100 isolation trees identifying structural zero-day anomalies in 24-dimensional feature space at 96.2% precision.',
  },
  {
    num: '(006)',
    title: 'Continuous Decaying Risk Engine',
    category: 'RISK QUANTIFICATION',
    desc: 'Dominant-signal multi-component risk scoring clamped to 0–100 with exponential time decay factor of λ=0.96.',
  },
  {
    num: '(007)',
    title: 'Temporal Bipartite Campaign Graphing',
    category: 'GRAPH INTELLIGENCE',
    desc: 'Interactive D3 force-directed attack graph correlating infected hosts, external C2 nodes, and resolvers across time.',
  },
  {
    num: '(008)',
    title: 'SHA-256 Blockchain Forensic Ledger',
    category: 'IMMUTABLE AUDIT',
    desc: 'Tamper-evident cryptographic ledger sealing all detections, inferences, and simulation events into an immutable chain.',
  },
  {
    num: '(009)',
    title: 'Information-Theoretic DNS Tunneling Detection',
    category: 'COVERT CHANNEL',
    desc: 'Real-time Shannon entropy calculation and subdomain churn analysis uncovering Base32/64 exfiltration without decryption.',
  },
  {
    num: '(010)',
    title: 'Stateless Connection Starvation Defense',
    category: 'L4 STATELESS PROTOCOL',
    desc: 'Detects Slowloris and incomplete HTTP headers using incomplete connection ratios without allocating kernel socket tables.',
  },
  {
    num: '(011)',
    title: 'Sub-Millisecond Alert Broadcast Hub',
    category: 'REAL-TIME WEBSOCKET',
    desc: 'High-throughput async event bus streaming live metrics, threat evidence cards, and risk updates to SOC consoles in 1.45 ms.',
  },
  {
    num: '(012)',
    title: 'Air-Gapped Cyber Range Synthesis',
    category: 'SIMULATION & BENCHMARK',
    desc: 'Self-contained synthetic traffic generator executing hping3 floods, Slowloris, and dnscat2 attacks for jury evaluation.',
  },
];
